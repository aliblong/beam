...
public class BigQueryIO {
  ...
  public static class Read extends PTransform<PBegin, PCollection<TableRow>> {
    ...
    /**
     * Provides a custom location on GCS for storing the temporary files generated by BigQuery
     * queries. If this is not set, tempLocation will be used.
     */
    public Read withCustomGcsTempLocation(ValueProvider<String> customGcsTempLocation) {
      checkArgument(customGcsTempLocation != null, "customGcsTempLocation can not be null");
      return new Read(this.inner.withCustomGcsTempLocation(customGcsTempLocation));
    }
  }
  ...
  public abstract static class TypedRead<T> extends PTransform<PBegin, PCollection<T>> {
    ...
    /** See {@link Read#withCustomGcsTempLocation()}. */
    public TypedRead<T> withCustomGcsTempLocation(ValueProvider<String> customGcsTempLocation) {
